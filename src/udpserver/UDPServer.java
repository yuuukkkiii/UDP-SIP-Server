...
//                if("".equals(requestMsg)||"".equals(requestMsg.trim())){
//                    continue;
//                }
//            try {
...
//                    //String sipUri = r.contact.substring(r.contact.indexOf(":")+1, r.contact.length());
...
//                            r.cSeq = nextLine.substring(nextLine.indexOf(" ") + 1, nextLine.length());
//                        else if ("Contact".equals(feildName)) {
//                            System.out.println("接收到的contact内容为：  "+nextLine);
//                            r.contact = nextLine.substring(nextLine.indexOf(" "), nextLine.length());
//                        }
...
//
//
//                    System.out.println("发送给拨号方的报文信息： "+r.forwardInvite(line1, servIp, servPort));
...
//
//                    int callTarget = r.callId.indexOf("@");
//                    String callId = r.callId.substring(0, callTarget == -1 ? r.callId.length() : callTarget);
